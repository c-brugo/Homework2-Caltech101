...
class DANN_AlexNet(nn.Module):
    ...
    def __init__(self, num_classes: int = 1000, num_domains: int = 2) -> None:
...
def dann(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> DANN_AlexNet:
    r"""DANN based on AlexNet model architecture from the
